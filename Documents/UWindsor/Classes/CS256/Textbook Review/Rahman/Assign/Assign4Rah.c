...
int main(int argc, char *argv[]){
    ...
    while(1)
    {
        printf("\nEnter a list of commands with arguments,\n");
        printf("seperated by semi-colon (;), [CTR-C to exit]> ");
        ...
        {
            arg_list[0] = NULL;
            ampersand = read_args(arg_set, arg_list);
...
int read_args(char *line, char* arg_list[])
{
    ...
    /*last token is now stored in arg_list[x-1]*/
    if (arg_list[0] != NULL )
    {
