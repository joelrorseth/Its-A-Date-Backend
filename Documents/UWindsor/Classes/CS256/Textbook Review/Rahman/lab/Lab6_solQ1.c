...
int main()
{
    ...
    //To handle simple signal SIGTERM
    ...
    if((pid3 = fork()) == 0) play_game("Player 3", 3);
    if((pid4 = fork()) == 0) play_game("Player 4", 4);
    ...
    while(1)
    {
        ...
        printf("Referee: Player 3 plays\n\n");
        
        kill(pid3, SIGUSR1);
        pause();
        
        printf("Referee: Player 4 plays\n\n");
